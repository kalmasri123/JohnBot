...
const pauseAction:Action = async function({message,guild}:ActionContext,fn){
...
let decorated: Action = ClearIfNoVoiceConnection()(CreateVoiceStateIfNotExists()(pauseAction));
